...
function createFeatures(earthquakeData, platesData){
    ...
    // Create a variable for earthquakes for lat and lng, each feature for popup, and cicrle radius/color/weight/opacity
...
// Create pallet - small blue to large red
...
legend.onAdd = function() {
    ...
    var labels = [];
    var legendInfo = "<h4>Magnitude of Earthquake</h4>";

    div.innerHTML = legendInfo

    // go through each magnitude item to label / colour legend
...
function createMap(earthquakes) {
    ...
    // Define layers
   let streetstylemap = L.tileLayer("https://maps.googleapis.com/maps/api/js?key=API_KEY&callback=initMap&v=weekly", {
  ...
  let graymap = L.tileLayer("https://maps.googleapis.com/maps/api/js?key=API_KEY&callback=initMap&v=weekly", {
    attribution: "Map data &copy; <a href=\"https://www.openstreetmap.org/\">OpenStreetMap</a> contributors, <a href=\"https://creativecommons.org/licenses/by-sa/2.0/\">CC-BY-SA</a>, Imagery © <a href=\"https://www.mapbox.com/\">Mapbox</a>",
    maxZoom: 20,
    id: "light-v10",
    accessToken: API_KEY
