...
function createMap(earthquakes) {
    ...
    // Define layers
   let streetstylemap = L.tileLayer("https://maps.googleapis.com/maps/api/js?key=API_KEY&callback=initMap", {
  ...
  let graymap = L.tileLayer("https://maps.googleapis.com/maps/api/js?key=API_KEY&callback=initMap", {
    attribution: "Map data &copy; <a href=\"https://www.openstreetmap.org/\">OpenStreetMap</a> contributors, <a href=\"https://creativecommons.org/licenses/by-sa/2.0/\">CC-BY-SA</a>, Imagery © <a href=\"https://www.mapbox.com/\">Mapbox</a>",
    maxZoom: 20,
    id: "light-v10",
    accessToken: API_KEY
